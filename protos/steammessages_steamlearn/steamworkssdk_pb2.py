...
from steammessages_unified_base import (
    steamworkssdk_pb2 as steammessages__unified__base_dot_steamworkssdk__pb2,
)
...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "steammessages_steamlearn.steamworkssdk_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _STEAMLEARN.methods_by_name["RegisterDataSource"]._serialized_options = (
    ...
    _STEAMLEARN.methods_by_name["CacheData"]._serialized_options = (
        b"\202\265\030\034Updates a cached data entry."
    )
    _STEAMLEARN.methods_by_name["SnapshotProject"]._options = None
    _STEAMLEARN.methods_by_name["SnapshotProject"]._serialized_options = (
        b"\202\265\030)Snapshots the current data for a project."
    )
    _STEAMLEARN.methods_by_name["BatchOperation"]._options = None
    _STEAMLEARN.methods_by_name["BatchOperation"]._serialized_options = (
        b"\202\265\030SBatches multiple data updates, snapshots, and inference requests into a single call"
    )
    _STEAMLEARN.methods_by_name["GetAccessTokens"]._options = None
    _STEAMLEARN.methods_by_name["GetAccessTokens"]._serialized_options = (
        b"\202\265\030nGets the access tokens needed for registering data sources, submitting data to them, and snapshotting projects"
    )
    _STEAMLEARN.methods_by_name["Inference"]._options = None
    _STEAMLEARN.methods_by_name["Inference"]._serialized_options = (
    ...
    _STEAMLEARN.methods_by_name["InferenceMetadata"]._serialized_options = (
        b"\202\265\030@Requests the metadata that was generated from a specified fetch."
    )
    _ESTEAMLEARNDATATYPE._serialized_start = 6121
    _ESTEAMLEARNDATATYPE._serialized_end = 6333
    _ESTEAMMLEARNREGISTERDATASOURCERESULT._serialized_start = 6336
    _ESTEAMMLEARNREGISTERDATASOURCERESULT._serialized_end = 7036
    _ESTEAMLEARNCACHEDATARESULT._serialized_start = 7039
    _ESTEAMLEARNCACHEDATARESULT._serialized_end = 7418
    _ESTEAMLEARNSNAPSHOTPROJECTRESULT._serialized_start = 7421
    _ESTEAMLEARNSNAPSHOTPROJECTRESULT._serialized_end = 8170
    _ESTEAMLEARNGETACCESSTOKENSRESULT._serialized_start = 8172
    _ESTEAMLEARNGETACCESSTOKENSRESULT._serialized_end = 8288
    _ESTEAMLEARNINFERENCERESULT._serialized_start = 8291
    _ESTEAMLEARNINFERENCERESULT._serialized_end = 8788
    _ESTEAMLEARNINFERENCEMETADATARESULT._serialized_start = 8791
    _ESTEAMLEARNINFERENCEMETADATARESULT._serialized_end = 9268
    ...
    _CMSGSTEAMLEARN_INFERENCEMETADATA_RESPONSE._serialized_end = 5169
    _CMSGSTEAMLEARN_INFERENCEMETADATA_RESPONSE_ROWRANGE._serialized_start = 4168
    _CMSGSTEAMLEARN_INFERENCEMETADATA_RESPONSE_ROWRANGE._serialized_end = 4212
    _CMSGSTEAMLEARN_INFERENCEMETADATA_RESPONSE_RANGE._serialized_start = 4214
    _CMSGSTEAMLEARN_INFERENCEMETADATA_RESPONSE_RANGE._serialized_end = 4286
    _CMSGSTEAMLEARN_INFERENCEMETADATA_RESPONSE_STDDEV._serialized_start = 4288
    _CMSGSTEAMLEARN_INFERENCEMETADATA_RESPONSE_STDDEV._serialized_end = 4354
    _CMSGSTEAMLEARN_INFERENCEMETADATA_RESPONSE_COMPACTTABLE._serialized_start = 4357
    _CMSGSTEAMLEARN_INFERENCEMETADATA_RESPONSE_COMPACTTABLE._serialized_end = 4849
    _CMSGSTEAMLEARN_INFERENCEMETADATA_RESPONSE_COMPACTTABLE_ENTRY._serialized_start = (
        4575
    )
    _CMSGSTEAMLEARN_INFERENCEMETADATA_RESPONSE_COMPACTTABLE_ENTRY._serialized_end = 4629
    _CMSGSTEAMLEARN_INFERENCEMETADATA_RESPONSE_COMPACTTABLE_MAPVALUESENTRY._serialized_start = (
        4631
    )
    _CMSGSTEAMLEARN_INFERENCEMETADATA_RESPONSE_COMPACTTABLE_MAPVALUESENTRY._serialized_end = (
        4738
    )
    _CMSGSTEAMLEARN_INFERENCEMETADATA_RESPONSE_COMPACTTABLE_MAPMAPPINGSENTRY._serialized_start = (
        4740
    )
    _CMSGSTEAMLEARN_INFERENCEMETADATA_RESPONSE_COMPACTTABLE_MAPMAPPINGSENTRY._serialized_end = (
        4849
    )
    _CMSGSTEAMLEARN_INFERENCEMETADATA_RESPONSE_KMEANS._serialized_start = 4852
    _CMSGSTEAMLEARN_INFERENCEMETADATA_RESPONSE_KMEANS._serialized_end = 5066
    _CMSGSTEAMLEARN_INFERENCEMETADATA_RESPONSE_KMEANS_CLUSTER._serialized_start = 4953
    _CMSGSTEAMLEARN_INFERENCEMETADATA_RESPONSE_KMEANS_CLUSTER._serialized_end = 5066
    _CMSGSTEAMLEARN_INFERENCEMETADATA_RESPONSE_SNAPSHOTHISTOGRAM._serialized_start = (
        5068
    )
    _CMSGSTEAMLEARN_INFERENCEMETADATA_RESPONSE_SNAPSHOTHISTOGRAM._serialized_end = 5169
    _CMSGSTEAMLEARN_INFERENCEBACKEND_RESPONSE._serialized_start = 5172
    _CMSGSTEAMLEARN_INFERENCEBACKEND_RESPONSE._serialized_end = 5914
    _CMSGSTEAMLEARN_INFERENCEBACKEND_RESPONSE_REGRESSIONOUTPUT._serialized_start = 5283
    _CMSGSTEAMLEARN_INFERENCEBACKEND_RESPONSE_REGRESSIONOUTPUT._serialized_end = 5316
    _CMSGSTEAMLEARN_INFERENCEBACKEND_RESPONSE_BINARYCROSSENTROPYOUTPUT._serialized_start = (
        5318
    )
    _CMSGSTEAMLEARN_INFERENCEBACKEND_RESPONSE_BINARYCROSSENTROPYOUTPUT._serialized_end = (
        5359
    )
    _CMSGSTEAMLEARN_INFERENCEBACKEND_RESPONSE_MUTLIBINARYCROSSENTROPYOUTPUT._serialized_start = (
        5361
    )
    _CMSGSTEAMLEARN_INFERENCEBACKEND_RESPONSE_MUTLIBINARYCROSSENTROPYOUTPUT._serialized_end = (
        5423
    )
    _CMSGSTEAMLEARN_INFERENCEBACKEND_RESPONSE_CATEGORICALCROSSENTROPYOUTPUT._serialized_start = (
        5425
    )
    _CMSGSTEAMLEARN_INFERENCEBACKEND_RESPONSE_CATEGORICALCROSSENTROPYOUTPUT._serialized_end = (
        5487
    )
    _CMSGSTEAMLEARN_INFERENCEBACKEND_RESPONSE_OUTPUT._serialized_start = 5490
    _CMSGSTEAMLEARN_INFERENCEBACKEND_RESPONSE_OUTPUT._serialized_end = 5914
    _CMSGSTEAMLEARN_INFERENCE_RESPONSE._serialized_start = 5917
    _CMSGSTEAMLEARN_INFERENCE_RESPONSE._serialized_end = 6118
    _STEAMLEARN._serialized_start = 9271
    _STEAMLEARN._serialized_end = 10570
